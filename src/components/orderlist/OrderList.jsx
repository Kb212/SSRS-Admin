  ...
  return (
    <section className="p-6 space-y-6">
      <div className="flex justify-between items-center pr-8">
        ...
        <Link className="bg-[#333] w-10 h-10 flex justify-center items-center rounded-md cursor-pointer" to="add-order">
          <FaPlus className="text-white text-2xl" />
        </Link>
      </div>
      <DynamicTable columns={columns} data={data} rowsPerPage={6} />
    </section>
  );
}
